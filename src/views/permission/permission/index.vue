  ...
  <div class="app-container">
    ...
    <template>
      <el-table :data="tableData" style="width: 100%" border>
        ...
        <el-table-column :label="$t('permission.permissionName')" prop="permissionName">
        </el-table-column>
    ...
    <el-dialog :title="$t('permission.user')" :visible.sync="permissionDialog" width="50%">
      <el-form :rules="rules" ref="ruleForm" :model="permissionForm" label-width="80px" style='width: 400px; margin-left:10px;'>
        <el-form-item prop="permissionName" :label="$t('permission.permissionName')">
          <el-input v-model="permissionForm.permissionName"></el-input>
        </el-form-item>
        <el-form-item prop="ruleName" :label="$t('permission.ruleName')">
          <el-input v-model="permissionForm.ruleName"></el-input>
        </el-form-item>
        <el-form-item :label="$t('permission.description')">
          <el-input type="textarea" :rows="2" v-model="permissionForm.description"></el-input>
        </el-form-item>
        <el-form-item :label="$t('permission.data')">
          <el-input type="textarea" :rows="2" v-model="permissionForm.data"></el-input>
        </el-form-item>
        <el-form-item>
